...
import { BulkTransactionReviewTable } from "~/components/transactions/BulkTransactionReviewTable";
...
export const Route = createFileRoute("/_app/transactions/bulk")({
  component: BulkTransactionsPage,
});
...
type PageMode = "idle" | "uploading" | "review" | "submitting";
...
function BulkTransactionsPage() {
  ...
  const handlePreviewRequest = async () => {
    ...
    try {
      const response = await previewBulkTransactions(formData);
