...
const OptionalDateFilterSchema = z
  .string()
  .optional()
  .describe(
...
const RecurringTransactionDetailSchema =
  RecurringTransactionSummarySchema.extend({
...
type BudgetChatTool =
  | Tool<
      typeof ListBudgetsInputSchema,
      z.ZodArray<typeof BudgetSummarySchema>,
      "list_budgets"
    >
  ...
  | Tool<
    ...
    >
  | Tool<
      typeof GetBudgetItemInputSchema,
      typeof BudgetItemDetailSchema,
      "get_budget_item"
    >
  | Tool<
  ...
  | Tool<
      ...
      typeof TransactionSummarySchema,
      "get_transaction"
    >
  | Tool<
